...
const CH_META = {
  ...
  '杜林': ['mondstadt', ['subdps']],
  '雅珂达': ['snezhnaya', ['support']],
  '哥伦比娅': ['snezhnaya', ['support']],
  '兹白': ['liyue', ['maindps']],
  '依鲁加': ['snezhnaya', ['subdps']],
  '莉奈娅': ['snezhnaya', ['support']],
  '尼可': ['snezhnaya', ['support']],
  '洛恩': ['mondstadt', ['maindps']],
  '布伦妮': ['snezhnaya', ['support']],
...
const RAW_CHARS = [
  ...
  ['迪卢克', 'pyro', 'crit', [['炽烈的炎之魔女'], ['未泯的梦']], ['atkP'], ['pyro'], ['cr', 'cd']],
  ...
  ['嘉明', 'pyro', 'crit', [['未泯的梦'], ['炽烈的炎之魔女']], ['atkP'], ['pyro'], ['cr', 'cd']],
  ...
  ['梦见月瑞希', 'hydro', 'em', [['翠绿之影'], ['饰金之梦', '流浪大地的乐团']], ['em', 'er'], ['em'], ['em']],
  ...
  ['基尼奇', 'dendro', 'crit', [['黑曜秘典'], ['未泯的梦']], ['atkP'], ['dendro'], ['cr', 'cd']],
  ['艾梅莉埃', 'dendro', 'atk', [['未泯的梦'], ['深林的记忆']], ['atkP'], ['dendro'], ['cr', 'cd']],
  ...
  ['雅珂达', 'anemo', 'er', [['翠绿之影'], ['翠绿之影', '昔日宗室之仪']], ['er'], ['atkP'], ['heal']],
  ['哥伦比娅', 'hydro', 'hp', [['晨星与月的晓歌'], ['千岩牢固', '昔日宗室之仪']], ['hpP', 'er'], ['hpP'], ['cr']],
  ['兹白', 'geo', 'critDef', [['穹境示现之夜'], ['华馆梦醒形骸记', '悠古的磐岩']], ['defP'], ['defP'], ['cr']],
  ['依鲁加', 'electro', 'em', [['饰金之梦'], ['饰金之梦', '流浪大地的乐团']], ['em'], ['em'], ['em']],
  ['莉奈娅', 'geo', 'critDef', [['华馆梦醒形骸记'], ['华馆梦醒形骸记', '千岩牢固']], ['defP'], ['geo'], ['cr']],

  /* ---------- 补遗：6.6–7.0（新版本，配装可能随环境微调） ---------- */
  ['尼可', 'pyro', 'er', [['天之美赐'], ['昔日宗室之仪', '千岩牢固']], ['er'], ['atkP'], ['cr']],
  ['洛恩', 'cryo', 'crit', [['风起之日'], ['冰风迷途的勇士', '苍白之火']], ['atkP'], ['cryo'], ['cr']],
  ['布伦妮', 'anemo', 'er', [['翠绿之影'], ['翠绿之影', '昔日宗室之仪']], ['er'], ['atkP'], ['atkP']],
