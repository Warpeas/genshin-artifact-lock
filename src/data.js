...
const RAW_CHARS = [
  /* ---------- 火 ---------- */
  ['胡桃',      'pyro', [
    {sets:['炽烈的炎之魔女'], sands:['hpP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'hpP', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '增幅反应']},
    {sets:['追忆之注连'], sands:['hpP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'hpP', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '充能']},
    {sets:['沙上楼阁史话'], sands:['hpP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'hpP', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
  ...
  ['迪卢克',      'pyro', [
    {sets:['炽烈的炎之魔女'], sands:['atkP', 'em'], goblet:['pyro', 'em'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
    {sets:['长夜之誓'], sands:['atkP', 'em'], goblet:['pyro', 'em'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
  ...
  ['可莉',      'pyro', [
    {sets:['风起之日'], sands:['atkP'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
    {sets:['逐影猎人'], sands:['atkP'], goblet:['pyro'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
  ...
  ['香菱',      'pyro', [
    ...
    {sets:['绝缘之旗印'], sands:['er', 'atkP'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['er', 'cr', 'cd'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
  ...
  ['班尼特',      'pyro', [
    {sets:['昔日宗室之仪'], sands:['er', 'hpP'], goblet:['hpP'], circlet:['heal', 'hpP', 'cr'], subs:['hpP', 'er', 'cr'], subRules:{required:['er', 'hpP'], equal:[], source:'heuristic'}, roles:['输出', '治疗', '辅助', '充能']},
  ...
  ['玛薇卡',      'pyro', [
    {sets:['黑曜秘典'], sands:['atkP', 'em'], goblet:['pyro', 'atkP'], circlet:['cd', 'atkP'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['烬城勇者绘卷'], sands:['atkP', 'em'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd', 'atkP'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
  ...
  ['阿蕾奇诺',      'pyro', [
    ...
    {sets:['逐影猎人'], sands:['atkP'], goblet:['pyro', 'atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
    {sets:['饰金之梦'], sands:['em', 'atkP'], goblet:['em', 'pyro', 'atkP'], circlet:['cd', 'cr'], subs:['cd', 'cr', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '增幅反应']},
  ...
  ['托马',      'pyro', [
    ...
    {sets:['乐园遗落之花'], sands:['em'], goblet:['em'], circlet:['em'], subs:['er', 'em'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['输出', '精通', '剧变反应']},
    {sets:['绝缘之旗印'], sands:['er', 'hpP'], goblet:['hpP'], circlet:['hpP'], subs:['er', 'hpP', 'cr', 'cd'], subRules:{required:['hpP'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['护盾']},
  ...
  ['烟绯',      'pyro', [
    {sets:['炽烈的炎之魔女'], sands:['atkP', 'em'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['逐影猎人'], sands:['atkP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['流浪大地的乐团'], sands:['atkP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['角斗士的终幕礼'], sands:['atkP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
  ...
  ['迪希雅',      'pyro', [
    ...
    {sets:['炽烈的炎之魔女'], sands:['er', 'atkP'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'hpP', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
    {sets:['饰金之梦'], sands:['em', 'er', 'atkP'], goblet:['em', 'pyro', 'atkP'], circlet:['em', 'cr', 'cd'], subs:['em', 'cr', 'cd', 'hpP', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '剧变反应']},
    {sets:['乐园遗落之花'], sands:['em', 'er', 'atkP'], goblet:['em', 'pyro', 'atkP'], circlet:['em', 'cr', 'cd'], subs:['em', 'cr', 'cd', 'hpP', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '剧变反应']},
    {sets:['千岩牢固'], sands:['er', 'atkP'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'hpP', 'atkP'], subRules:{required:['hpP'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '护盾', '辅助']},
  ...
  ['嘉明',      'pyro', [
    {sets:['长夜之誓'], sands:['atkP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
    {sets:['逐影猎人'], sands:['atkP', 'em'], goblet:['pyro'], circlet:['cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['炽烈的炎之魔女'], sands:['atkP', 'em'], goblet:['pyro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
  ...
  /* ---------- 水 ---------- */
  ['行秋',      'hydro', [
    {sets:['昔日宗室之仪'], sands:['atkP', 'er'], goblet:['hydro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '精通', '充能']},
    {sets:['绝缘之旗印'], sands:['er', 'atkP'], goblet:['hydro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
  ...
  ['夜兰',      'hydro', [
    {sets:['绝缘之旗印'], sands:['hpP', 'er'], goblet:['hydro', 'hpP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'er', 'hpP'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '充能']},
    {sets:['昔日宗室之仪'], sands:['hpP', 'er'], goblet:['hydro', 'hpP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'er', 'hpP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助']},
  ...
  ['珊瑚宫心海',      'hydro', [
    {sets:['海染砗磲'], sands:['hpP', 'er'], goblet:['hpP', 'hydro'], circlet:['heal'], subs:['hpP', 'er', 'em'], subRules:{required:['hpP'], equal:[], source:'heuristic'}, roles:['增伤', '治疗', '辅助']},
    {sets:['昔时之歌'], sands:['hpP', 'er'], goblet:['hpP', 'hydro'], circlet:['heal'], subs:['hpP', 'er', 'em'], subRules:{required:['hpP'], equal:[], source:'heuristic'}, roles:['增伤', '治疗']},
    {sets:['被怜爱的少女'], sands:['hpP', 'er'], goblet:['hpP', 'hydro'], circlet:['heal'], subs:['hpP', 'er', 'em'], subRules:{required:['hpP'], equal:[], source:'heuristic'}, roles:['增伤', '治疗']},
  ...
  ['妮露',      'hydro', [
    {sets:['千岩牢固', '花海甘露之光'], sands:['hpP'], goblet:['hpP'], circlet:['hpP'], subs:['em', 'hpP', 'cr', 'cd'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '精通']},
    {sets:['沉沦之心', '水仙之梦'], sands:['hpP'], goblet:['hydro', 'hpP'], circlet:['cr', 'cd', 'hpP'], subs:['em', 'cr', 'cd', 'hpP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['深林的记忆'], sands:['hpP'], goblet:['hydro', 'hpP'], circlet:['cr', 'cd', 'hpP'], subs:['em', 'cr', 'cd', 'hpP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '精通']},
  ...
  ['芙宁娜',      'hydro', [
    ...
    {sets:['千岩牢固'], sands:['hpP', 'er'], goblet:['hpP', 'hydro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'hpP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助']},
    {sets:['昔日宗室之仪'], sands:['hpP'], goblet:['hpP', 'hydro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'hpP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助']},
  ...
  ['那维莱特',      'hydro', [
    {sets:['逐影猎人'], sands:['hpP'], goblet:['hydro'], circlet:['cd', 'hpP'], subs:['cr', 'cd', 'hpP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['玛拉妮',      'hydro', [
    ...
    {sets:['饰金之梦'], sands:['hpP', 'em'], goblet:['hydro', 'hpP'], circlet:['cd', 'hpP'], subs:['cd', 'hpP', 'em', 'cr'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
    {sets:['沉沦之心'], sands:['hpP', 'em'], goblet:['hydro', 'hpP'], circlet:['cd', 'hpP'], subs:['cd', 'hpP', 'em', 'cr'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
  ...
  ['希格雯',      'hydro', [
    {sets:['昔时之歌'], sands:['hpP'], goblet:['hpP'], circlet:['hpP', 'heal'], subs:['hpP', 'er'], subRules:{required:['hpP'], equal:[], source:'heuristic'}, roles:['治疗', '辅助']},
    {sets:['海染砗磲'], sands:['hpP'], goblet:['hpP'], circlet:['hpP', 'heal'], subs:['hpP', 'er'], subRules:{required:['hpP'], equal:[], source:'heuristic'}, roles:['治疗', '辅助']},
    {sets:['千岩牢固'], sands:['hpP'], goblet:['hpP'], circlet:['hpP', 'heal'], subs:['hpP', 'er'], subRules:{required:['hpP'], equal:[], source:'heuristic'}, roles:['治疗', '辅助']},
  ...
  ['坎蒂丝',      'hydro', [
    {sets:['昔日宗室之仪'], sands:['er', 'hpP'], goblet:['hydro', 'hpP'], circlet:['hpP', 'cr'], subs:['cr', 'cd', 'hpP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '充能']},
    {sets:['绝缘之旗印'], sands:['er', 'hpP'], goblet:['hydro', 'hpP'], circlet:['hpP', 'cr'], subs:['cr', 'cd', 'hpP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
  ...
  ['神里绫华',      'cryo', [
    {sets:['冰风迷途的勇士'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cd', 'atkP'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
    {sets:['逐影猎人'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cd', 'atkP'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
    {sets:['绝缘之旗印'], sands:['atkP', 'er'], goblet:['cryo', 'atkP'], circlet:['cd', 'atkP'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
  ...
  ['莱欧斯利',      'cryo', [
    {sets:['影中沉凝的幻灭'], sands:['atkP'], goblet:['atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助']},
    {sets:['逐影猎人'], sands:['atkP', 'em'], goblet:['cryo'], circlet:['cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '精通']},
    {sets:['辰砂往生录'], sands:['em', 'atkP'], goblet:['cryo'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '精通']},
    {sets:['沙上楼阁史话'], sands:['atkP', 'em'], goblet:['cryo'], circlet:['cr', 'cd', 'atkP'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
  ...
  ['爱可菲',      'cryo', [
    ...
    {sets:['千岩牢固'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助']},
  ...
  ['丝柯克',      'cryo', [
    ...
    {sets:['逐影猎人'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cd'], subs:['cd', 'cr', 'atkP'], subRules:{required:[], equal:[], source:'manual'}, roles:['输出', '增伤']},
  ...
  ['重云',      'cryo', [
    {sets:['昔日宗室之仪'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
    {sets:['绝缘之旗印'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
  ...
  ['米卡',      'cryo', [
    ...
    {sets:['海染砗磲'], sands:['er', 'hpP'], goblet:['hpP'], circlet:['heal', 'hpP', 'cr'], subs:['er', 'hpP', 'cr'], subRules:{required:['hpP'], equal:[], source:'heuristic'}, roles:['治疗', '辅助']},
  ...
  /* ---------- 雷 ---------- */
  ['雷电将军',      'electro', [
    {sets:['绝缘之旗印'], sands:['er'], goblet:['electro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '充能']},
    {sets:['乐园遗落之花'], sands:['em'], goblet:['em'], circlet:['em'], subs:['em'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['精通', '剧变反应']},
  ...
  ['八重神子',      'electro', [
    {sets:['炉火融炼之心'], sands:['atkP'], goblet:['atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
    {sets:['千岩牢固'], sands:['atkP'], goblet:['atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['辅助']},
    {sets:['影中沉凝的幻灭'], sands:['atkP'], goblet:['atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['饰金之梦'], sands:['atkP', 'em'], goblet:['atkP', 'electro'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
  ...
  ['菲谢尔',      'electro', [
    ...
    {sets:['黄金剧团'], sands:['atkP', 'em'], goblet:['electro'], circlet:['cr'], subs:['cd', 'cr', 'atkP', 'em', 'er'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '副C', '精通']},
    {sets:['千岩牢固'], sands:['atkP', 'er'], goblet:['electro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er', 'em'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助']},
    {sets:['如雷的盛怒'], sands:['atkP', 'em'], goblet:['electro'], circlet:['cr'], subs:['cd', 'cr', 'atkP', 'em', 'er'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '剧变反应']},
    {sets:['苍白之火'], sands:['atkP'], goblet:['phys'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['刻晴',      'electro', [
    {sets:['如雷的盛怒'], sands:['atkP', 'em'], goblet:['electro'], circlet:['cr', 'cd'], subs:['cd', 'cr', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
  ...
  ['赛诺',      'electro', [
    ...
    {sets:['如雷的盛怒'], sands:['em', 'atkP'], goblet:['electro', 'atkP'], circlet:['cd', 'cr'], subs:['em', 'cr', 'cd', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
    {sets:['饰金之梦'], sands:['em', 'atkP'], goblet:['electro', 'atkP'], circlet:['cd', 'cr'], subs:['em', 'cr', 'cd', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
    {sets:['穹境示现之夜'], sands:['em', 'atkP'], goblet:['electro', 'atkP'], circlet:['cd', 'cr'], subs:['em', 'cr', 'cd', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '精通', '剧变反应']},
    {sets:['角斗士的终幕礼'], sands:['atkP', 'em'], goblet:['electro', 'atkP'], circlet:['cd', 'cr'], subs:['em', 'cr', 'cd', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
  ...
  ['九条裟罗',      'electro', [
    ...
    {sets:['绝缘之旗印'], sands:['atkP', 'er'], goblet:['electro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '充能']},
  ...
  ['雷泽',      'electro', [
    ...
    {sets:['苍白之火'], sands:['atkP'], goblet:['phys', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
    {sets:['角斗士的终幕礼'], sands:['atkP'], goblet:['phys', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
  ...
  ['克洛琳德',      'electro', [
    ...
    {sets:['如雷的盛怒'], sands:['atkP'], goblet:['electro', 'atkP'], circlet:['cd', 'cr'], subs:['cd', 'cr', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通']},
    {sets:['逐影猎人'], sands:['atkP'], goblet:['electro', 'atkP'], circlet:['cd'], subs:['cd', 'cr', 'atkP', 'em'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['瓦雷莎',      'electro', [
    ...
    {sets:['黑曜秘典'], sands:['atkP'], goblet:['electro', 'atkP'], circlet:['cd', 'atkP'], subs:['cd', 'cr', 'atkP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['砂糖',      'anemo', [
    {sets:['翠绿之影'], sands:['em', 'er'], goblet:['em'], circlet:['em'], subs:['em', 'er'], subRules:{required:['em', 'er'], equal:[], source:'heuristic'}, roles:['减抗', '精通', '充能']},
  ...
  ['琴',      'anemo', [
    {sets:['翠绿之影'], sands:['atkP', 'er'], goblet:['atkP'], circlet:['heal', 'cr'], subs:['cr', 'er', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '减抗', '辅助']},
    {sets:['昔日宗室之仪'], sands:['atkP', 'er'], goblet:['atkP'], circlet:['heal', 'cr'], subs:['cr', 'er', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '辅助']},
  ...
  ['魈',      'anemo', [
    ...
    {sets:['逐影猎人'], sands:['atkP'], goblet:['atkP', 'anemo'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['鹿野院平藏',      'anemo', [
    {sets:['翠绿之影'], sands:['atkP'], goblet:['anemo', 'atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通', '剧变反应']},
  ...
  ['早柚',      'anemo', [
    {sets:['翠绿之影'], sands:['er', 'em', 'atkP'], goblet:['em', 'atkP', 'anemo'], circlet:['heal', 'em', 'atkP'], subs:['er', 'em', 'atkP'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['增伤', '减抗', '精通']},
    {sets:['被怜爱的少女'], sands:['er', 'em', 'atkP'], goblet:['em', 'atkP', 'anemo'], circlet:['heal', 'em', 'atkP'], subs:['er', 'em', 'atkP'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['增伤', '精通']},
    {sets:['昔日宗室之仪'], sands:['er', 'em', 'atkP'], goblet:['em', 'atkP', 'anemo'], circlet:['heal', 'em', 'atkP'], subs:['er', 'em', 'atkP'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
    {sets:['流浪大地的乐团'], sands:['er', 'em', 'atkP'], goblet:['em', 'atkP', 'anemo'], circlet:['heal', 'em', 'atkP'], subs:['er', 'em', 'atkP'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['增伤', '精通']},
  ...
  ['流浪者',      'anemo', [
    {sets:['沙上楼阁史话'], sands:['atkP'], goblet:['anemo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['来歆余响'], sands:['atkP'], goblet:['anemo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['追忆之注连'], sands:['atkP'], goblet:['anemo', 'atkP'], circlet:['cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['逐影猎人'], sands:['atkP'], goblet:['anemo', 'atkP'], circlet:['cd'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
  ...
  ['恰斯卡',      'anemo', [
    {sets:['黑曜秘典'], sands:['atkP'], goblet:['atkP'], circlet:['cd'], subs:['cd', 'atkP', 'cr'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['琳妮特',      'anemo', [
    {sets:['翠绿之影'], sands:['atkP', 'er'], goblet:['anemo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'er', 'cd', 'atkP'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '充能']},
    {sets:['昔日宗室之仪'], sands:['atkP', 'er'], goblet:['anemo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'er', 'cd', 'atkP'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '充能']},
    {sets:['逐影猎人'], sands:['atkP', 'er'], goblet:['anemo', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'er', 'cd', 'atkP'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
  ...
  ['伊法',      'anemo', [
    {sets:['翠绿之影'], sands:['em', 'atkP'], goblet:['em', 'anemo'], circlet:['em', 'cr', 'cd'], subs:['em', 'cr', 'cd', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '剧变反应']},
    {sets:['烬城勇者绘卷'], sands:['em', 'atkP'], goblet:['em', 'anemo'], circlet:['em', 'cr', 'cd'], subs:['em', 'cr', 'cd', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
    {sets:['黑曜秘典'], sands:['atkP'], goblet:['anemo'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['梦见月瑞希',      'anemo', [
    {sets:['翠绿之影'], sands:['em', 'er'], goblet:['em'], circlet:['em'], subs:['em', 'er', 'cr'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['精通', '剧变反应']},
    {sets:['血红之证'], sands:['em', 'er'], goblet:['em'], circlet:['cr', 'cd', 'em'], subs:['em', 'er', 'cr'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['输出', '增伤', '辅助', '精通', '剧变反应']},
    {sets:['饰金之梦'], sands:['em', 'er'], goblet:['em'], circlet:['em'], subs:['em', 'er', 'cr'], subRules:{required:['em'], equal:[], source:'heuristic'}, roles:['精通']},
  ...
  /* ---------- 岩 ---------- */
  ['钟离',      'geo', [
    {sets:['千岩牢固'], sands:['hpP', 'er'], goblet:['hpP', 'geo'], circlet:['hpP', 'cr'], subs:['hpP', 'er', 'cr', 'cd'], subRules:{required:['hpP'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '护盾', '辅助']},
    {sets:['悠古的磐岩'], sands:['hpP', 'er'], goblet:['hpP', 'geo'], circlet:['hpP', 'cr'], subs:['hpP', 'er', 'cr', 'cd'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助']},
  ...
  ['诺艾尔',      'geo', [
    {sets:['华馆梦醒形骸记'], sands:['defP'], goblet:['geo'], circlet:['cr', 'cd', 'defP'], subs:['defP', 'cr', 'cd'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
    {sets:['逐影猎人'], sands:['defP'], goblet:['geo'], circlet:['cr', 'cd', 'defP'], subs:['defP', 'cr', 'cd'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  /* ---------- 草 ---------- */
  ['纳西妲',      'dendro', [
    {sets:['深林的记忆'], sands:['em'], goblet:['em', 'dendro'], circlet:['em', 'cr', 'cd'], subs:['em', 'cr', 'cd', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '减抗', '辅助', '精通', '充能']},
    {sets:['黄金剧团'], sands:['em'], goblet:['em', 'dendro'], circlet:['em', 'cr', 'cd'], subs:['em', 'cr', 'cd', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
    {sets:['深林的记忆', '饰金之梦'], sands:['em'], goblet:['em', 'dendro'], circlet:['em', 'cr', 'cd'], subs:['em', 'cr', 'cd', 'er'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通', '充能']},
  ...
  ['艾尔海森',      'dendro', [
    {sets:['饰金之梦'], sands:['em', 'atkP'], goblet:['dendro', 'em'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['深林的记忆', '饰金之梦'], sands:['em', 'atkP'], goblet:['dendro', 'em'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['深林的记忆'], sands:['em', 'atkP'], goblet:['dendro', 'em'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '精通']},
  ...
  ['提纳里',      'dendro', [
    {sets:['流浪大地的乐团'], sands:['em', 'atkP'], goblet:['dendro', 'atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '剧变反应']},
    {sets:['饰金之梦'], sands:['em', 'atkP'], goblet:['dendro', 'atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'em', 'atkP'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '剧变反应']},
  ...
  ['艾梅莉埃',      'dendro', [
    ...
    {sets:['深林的记忆'], sands:['atkP'], goblet:['dendro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '减抗', '辅助']},
  ...
  ['卡维',      'dendro', [
    ...
    {sets:['乐园遗落之花'], sands:['er', 'em'], goblet:['em'], circlet:['em'], subs:['er', 'em', 'atkP', 'cr'], subRules:{required:['em', 'er'], equal:[], source:'heuristic'}, roles:['输出', '精通', '充能', '剧变反应']},
    {sets:['饰金之梦', '流浪大地的乐团'], sands:['er', 'em'], goblet:['em'], circlet:['em'], subs:['er', 'em', 'atkP', 'cr'], subRules:{required:['em', 'er'], equal:[], source:'heuristic'}, roles:['输出', '精通', '充能']},
  ...
  ['绮良良',      'dendro', [
    {sets:['花海甘露之光', '千岩牢固'], sands:['hpP'], goblet:['hpP'], circlet:['hpP'], subs:['hpP', 'er', 'cr', 'em'], subRules:{required:['em', 'er', 'hpP'], equal:[], source:'heuristic'}, roles:['输出', '护盾', '精通', '充能']},
    {sets:['深林的记忆'], sands:['hpP'], goblet:['hpP'], circlet:['hpP'], subs:['hpP', 'er', 'cr', 'em'], subRules:{required:['em', 'er'], equal:[], source:'heuristic'}, roles:['输出', '减抗', '精通', '充能']},
    {sets:['昔日宗室之仪'], sands:['hpP'], goblet:['hpP'], circlet:['hpP'], subs:['hpP', 'er', 'cr', 'em'], subRules:{required:['em', 'er'], equal:[], source:'heuristic'}, roles:['输出', '辅助', '精通', '充能']},
  ...
  ['丽莎',      'electro', [
    {sets:['如雷的盛怒'], sands:['er', 'atkP'], goblet:['electro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er', 'em'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '精通', '充能']},
  ...
  ['凯亚',      'cryo', [
    ...
    {sets:['绝缘之旗印'], sands:['atkP'], goblet:['cryo'], circlet:['cr', 'cd'], subs:['cd', 'cr', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
    {sets:['冰风迷途的勇士'], sands:['atkP'], goblet:['cryo'], circlet:['cd'], subs:['cd', 'cr', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['北斗',      'electro', [
    {sets:['绝缘之旗印'], sands:['er', 'atkP'], goblet:['electro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
    {sets:['昔日宗室之仪'], sands:['er', 'atkP'], goblet:['electro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '充能']},
    {sets:['如雷的盛怒'], sands:['er', 'atkP'], goblet:['electro'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '充能']},
  ...
  ['千织',      'geo', [
    ...
    {sets:['千岩牢固'], sands:['defP'], goblet:['geo', 'defP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'defP', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助']},
  ...
  ['珐露珊',      'anemo', [
    {sets:['千岩牢固'], sands:['er'], goblet:['anemo', 'atkP'], circlet:['cr', 'cd'], subs:['er', 'cr', 'cd', 'atkP'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '充能']},
    {sets:['昔日宗室之仪'], sands:['er'], goblet:['anemo', 'atkP'], circlet:['cr', 'cd'], subs:['er', 'cr', 'cd', 'atkP'], subRules:{required:['er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助', '充能']},
  ...
  ['赛索斯',      'electro', [
    ...
    {sets:['饰金之梦'], sands:['em'], goblet:['electro', 'em'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'em', 'er'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
  ...
  ['奈芙尔',      'dendro', [
    {sets:['穹境示现之夜'], sands:['em'], goblet:['em'], circlet:['cd', 'em', 'cr'], subs:['cd', 'cr', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['饰金之梦'], sands:['em'], goblet:['em'], circlet:['cd', 'cr', 'em'], subs:['cd', 'cr', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['精通']},
  ...
  ['杜林',      'pyro', [
    {sets:['风起之日'], sands:['atkP', 'em'], goblet:['pyro', 'atkP', 'em'], circlet:['cr', 'cd'], subs:['cd', 'cr', 'atkP', 'em', 'er'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['天之美赐'], sands:['atkP', 'er'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '辅助']},
    {sets:['昔日宗室之仪'], sands:['atkP', 'er'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助']},
    {sets:['深林的记忆'], sands:['atkP', 'er'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'atkP', 'er'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '减抗', '辅助']},
  ...
  ['哥伦比娅',      'hydro', [
    {sets:['晨星与月的晓歌'], sands:['er', 'hpP'], goblet:['hpP'], circlet:['cr', 'cd', 'hpP'], subs:['cd', 'cr', 'hpP', 'er', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '副C', '精通']},
    {sets:['纺月的夜歌'], sands:['er', 'hpP'], goblet:['hpP'], circlet:['cr', 'cd', 'hpP'], subs:['cd', 'cr', 'hpP', 'er', 'em'], subRules:{required:['em', 'er'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通', '充能']},
    {sets:['穹境示现之夜'], sands:['er', 'hpP'], goblet:['hpP'], circlet:['cd', 'hpP'], subs:['cd', 'cr', 'hpP', 'er', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '精通']},
  ...
  ['兹白',      'geo', [
    {sets:['穹境示现之夜'], sands:['defP', 'em'], goblet:['defP', 'em'], circlet:['cd', 'cr', 'defP'], subs:['cr', 'cd', 'defP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '精通']},
    {sets:['华馆梦醒形骸记'], sands:['defP', 'em'], goblet:['defP', 'em'], circlet:['cr', 'cd'], subs:['cr', 'cd', 'defP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['精通']},
  ...
  ['桑多涅',      'cryo', [
    {sets:['影中沉凝的幻灭'], sands:['atkP'], goblet:['atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
    {sets:['饰金之梦'], sands:['atkP'], goblet:['atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['精通']},
  ...
  ['阿罗夏',      'electro', [
    {sets:['炉火融炼之心'], sands:['er'], goblet:['atkP'], circlet:['heal', 'atkP'], subs:['er', 'atkP'], roles:['增伤', '辅助', '精通']},
  ...
  ['洛恩',      'cryo', [
    {sets:['风起之日'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
    {sets:['逐影猎人'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
    {sets:['冰风迷途的勇士'], sands:['atkP'], goblet:['cryo', 'atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP'], subRules:{required:[], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤']},
  ...
  ['尼可',      'pyro', [
    {sets:['天之美赐'], sands:['atkP'], goblet:['atkP'], circlet:['atkP'], subs:['atkP', 'er'], subRules:{required:['er'], equal:[], source:'heuristic'}, roles:['增伤', '充能']},
  ...
  ['布伦妮',      'anemo', [
    ...
    {sets:['天之美赐'], sands:['er', 'atkP'], goblet:['atkP'], circlet:['atkP'], subs:['er', 'atkP'], subRules:{required:['er'], equal:[], source:'heuristic'}, roles:['增伤', '辅助', '充能']},
  ...
  ['旅行者·火',      'pyro', [
    {sets:['烬城勇者绘卷'], sands:['atkP', 'em'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd', 'atkP'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['增伤', '辅助', '精通']},
    {sets:['黑曜秘典'], sands:['atkP', 'em'], goblet:['pyro', 'atkP'], circlet:['cd', 'atkP'], subs:['cd', 'atkP', 'cr', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['长夜之誓'], sands:['atkP', 'em'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd', 'atkP'], subs:['cd', 'atkP', 'cr', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
    {sets:['角斗士的终幕礼'], sands:['atkP', 'em'], goblet:['pyro', 'atkP'], circlet:['cr', 'cd', 'atkP'], subs:['cd', 'atkP', 'cr', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['输出', '增伤', '精通']},
  ...
  ['旅行者·冰',       'cryo', [
    ...
    {sets:['炉火融炼之心'], sands:['atkP'], goblet:['atkP'], circlet:['cd', 'cr'], subs:['cr', 'cd', 'atkP', 'em'], subRules:{required:['em'], equal:[['cr', 'cd']], source:'heuristic'}, roles:['辅助', '精通']},
